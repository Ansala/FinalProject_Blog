...
class Comments extends Component {
    ...
    getBook = () => {
        axios.get("/api/blog/" + this.props.match.params.id).then(res => {
            ...
            this.setState({ blog: res.data.description, author: res.data.author })
        })
    }
            ...
            <div>
                ...
                {loggedIn ? (
                    <form className="commentForm">
                        ...
                        <Link to={"/login"} className="btn btn-primary" id="logintoadd" role="button">Login to add to this blog</Link>
                    )}
            </div>
        )
    }
